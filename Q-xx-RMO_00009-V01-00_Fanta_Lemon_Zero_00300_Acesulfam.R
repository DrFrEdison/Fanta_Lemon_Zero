...
dt$para.pls$wlm <- .wlr_function_multi(200:280, 200:280, 10)
...
dt$pls$mergesite <- .merge_pls_site(merge_pls_lm_predict_ls = dt$pls$merge, number = 500, ncomp = dt$para.pls$ncomp)
